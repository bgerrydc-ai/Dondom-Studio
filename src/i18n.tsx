...
export const translations = {
  es: {
    ...
    checkout: {
      ...
      intNum: 'No. Interior',
      zip: 'Código Postal *',
      cpAutoNote: 'Sugerimos colonia y estado — verifica que sean correctos.',
      colonia: 'Colonia *',
      city: 'Ciudad *',
    ...
    cuenta: {
      ...
      orDivider: 'o',
      googleTermsNote: 'Al continuar con Google, aceptas nuestros Términos y Condiciones y Política de Privacidad.',
      ...
      wrongCurrentPass: 'La contraseña actual no es correcta.',
      ...
      tabSeguridad: 'Seguridad',
      tabPrefs: 'Preferencias',
      // Estados de pedido (traducción de lo que viene de la base de datos)
      estadoPendiente: 'Pendiente',
      estadoPagado: 'Pagado',
      estadoEnviado: 'Enviado',
      estadoEntregado: 'Entregado',
      verPendientes: 'Ver compras sin terminar',
      ocultarPendientes: 'Ocultar compras sin terminar',
      pendientesNote:
  ...
  en: {
    ...
    checkout: {
      ...
      intNum: 'Int. number',
      zip: 'ZIP code *',
      cpAutoNote: 'We suggested a neighborhood and state — please double-check them.',
    ...
    cuenta: {
      ...
      orDivider: 'or',
      googleTermsNote: 'By continuing with Google, you accept our Terms and Conditions and Privacy Policy.',
      ...
      wrongCurrentPass: 'Your current password is incorrect.',
      ...
      tabSeguridad: 'Security',
      tabPrefs: 'Preferences',
      estadoPendiente: 'Pending',
      estadoPagado: 'Paid',
      estadoEnviado: 'Shipped',
      estadoEntregado: 'Delivered',
      verPendientes: 'Show unfinished purchases',
      ocultarPendientes: 'Hide unfinished purchases',
      pendientesNote:
