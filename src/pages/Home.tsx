...
export default function Home() {
  ...
  const whatsappProveedores = `https://wa.me/${CONTACT.whatsapp}?text=Hola%20DONDOM%20STUDIO!%20Me%20interesa%20conocer%20sus%20servicios%20de%20formulaci%C3%B3n%20de%20aromas%20para%20proveedores.`;
      ...
      >
        <main>
            ...
            <div className="flex-1 p-8 md:p-12 flex flex-col justify-between relative overflow-hidden">
              ...
              >
                <motion.div variants={itemVariants} className="max-w-[150px]">
                  ...
                  <p className="font-mono text-[9px] text-brand-gray-400 uppercase leading-relaxed">
                    Aromas diseñados para transformar ambientes con precisión.
                  </p>
                </motion.div>
                <motion.div variants={itemVariants} className="max-w-[200px] mt-4">
                  <p className="font-mono text-[9px] text-brand-gray-400 uppercase leading-relaxed pt-2">
                    Difusores avant-garde. Ingeniería de aroma para entornos que exigen distinción.
                  </p>
                </motion.div>
              </motion.div>
              ...
              <div className="mt-auto mb-20 lg:mb-32">
                ...
                >
                  <a
                    href="#catalogo"
                    className="inline-flex items-center gap-3 bg-brand-blue text-white font-mono text-[10px] uppercase tracking-widest px-6 py-3 hover:bg-brand-black transition-colors"
                  >
                    Ver Colección
          ...
          <section id="catalogo" className="p-8 md:p-24 bg-brand-white">
            <div className="max-w-6xl mx-auto">
              <div className="flex justify-between items-end mb-16 border-b border-brand-black pb-8">
                <motion.h2
                      ...
                      {!product.image ? (
                        <div className="flex flex-col items-center justify-center gap-4 opacity-30">
                          ...
                          <span className="font-mono text-[9px] uppercase tracking-widest">
                            {product.available ? 'Imagen próximamente' : 'Próximamente'}
                          </span>
                        </div>
                      ) : (
                        <img
            ...
            <div className="lg:w-1/2 bg-brand-black text-brand-white p-12 lg:p-24 flex flex-col justify-center relative">
              ...
              <div className="max-w-md">
                ...
                <div className="space-y-6 font-mono text-xs uppercase tracking-widest leading-relaxed text-brand-gray-300">
                  <p>
                    Un estudio de aroma creativo que opera en la intersección del diseño y la sensorialidad.
                  </p>
                  <p className="text-brand-gray-400">
                    Ingeniamos experiencias olfativas que transforman ambientes con precisión y distinción.
                  </p>
                </div>
        ...
        <footer className="p-8 border-t border-brand-gray-200 bg-brand-white flex flex-col md:flex-row justify-between items-center gap-2">
          <p className="font-mono text-[9px] uppercase tracking-widest text-brand-gray-400">
            DONDOM STUDIO — Instrumentos de Aroma
          </p>
          <p className="font-mono text-[9px] uppercase tracking-widest text-brand-gray-400">
            {CONTACT.phone}
          </p>
